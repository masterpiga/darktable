                                     ...
                                     const gboolean is_base)
{
  ...
  // out entirely shifted this row's own right edge relative to every other
  // row kind in the panel.
  gtk_box_pack_end(GTK_BOX(hdr), _make_badge_stack(_make_lowop_badge(), _make_solo_status_badge()),
                                          ...
                                          GtkWidget **picker_box_out)
{
  ...
  // built after them, which is the row's one visible picker button.
